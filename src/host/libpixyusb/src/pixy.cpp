...
int Pixy::get_blocks(uint16_t max_blocks, struct Block * blocks)
{
  return interpreter.get_blocks(max_blocks, blocks);
}

int Pixy::blocks_are_new()
{
  return interpreter.blocks_are_new();
}

int Pixy::command(const char *name, ...)
{
  va_list arguments;
  int     return_value;
...
void Pixy::error(int error_code)
{
  int index;
...
int Pixy::led_set_RGB(uint8_t red, uint8_t green, uint8_t blue)
{
  int      chirp_response;
  int      return_value;
  uint32_t RGB;
...
int Pixy::led_set_max_current(uint32_t current)
{
  int chirp_response;
  int return_value;
...
int Pixy::cam_set_auto_white_balance(uint8_t enable)
{
  int      return_value;
  uint32_t chirp_response;
...
int Pixy::cam_get_auto_white_balance()
{
  int      return_value;
  uint32_t chirp_response;
...
uint32_t Pixy::cam_get_white_balance_value()
{
  int      return_value;
  uint32_t chirp_response;
...
int Pixy::cam_set_white_balance_value(uint8_t red, uint8_t green, uint8_t blue)
{
  int      return_value;
  uint32_t chirp_response;
...
int Pixy::cam_set_auto_exposure_compensation(uint8_t enable)
{
  int      return_value;
  uint32_t chirp_response;
...
int Pixy::cam_get_auto_exposure_compensation()
{
  int      return_value;
  uint32_t chirp_response;
...
int Pixy::cam_set_exposure_compensation(uint8_t gain, uint16_t compensation)
{
  int      return_value;
  uint32_t chirp_response;
  uint32_t exposure;
...
int Pixy::cam_get_exposure_compensation(uint8_t * gain, uint16_t * compensation)
{
  uint32_t exposure;
  int      return_value;
...
int Pixy::cam_set_brightness(uint8_t brightness)
{
  int chirp_response;
  int return_value;
...
int Pixy::rcs_get_position(uint8_t channel)
{
  int chirp_response;
  int return_value;
...
int Pixy::rcs_set_position(uint8_t channel, uint16_t position)
{
  int chirp_response;
  int return_value;
...
int Pixy::rcs_set_frequency(uint16_t frequency)
{
  int chirp_response;
  int return_value;
...
int Pixy::get_firmware_version(uint16_t * major, uint16_t * minor, uint16_t * build)
{
